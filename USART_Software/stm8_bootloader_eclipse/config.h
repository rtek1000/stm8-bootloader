...
/* UART configuration */
//#define BAUDRATE            115200 // BAUDRATE by Timers: (9600)
...
/* application address */ // 0x83C0 = 960 bytes; 0x8280 = 640 bytes
#define BOOT_ADDR           0x83C0 // 0x8280
...
/* entry jumper */
#define BOOT_PIN            3
#define BOOT_PIN_IDR        PC_IDR
#define BOOT_PIN_CR1        PC_CR1
